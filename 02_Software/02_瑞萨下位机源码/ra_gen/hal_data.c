...
const timer_cfg_t g_timer2_cfg =
{
    ...
    .channel             = 2,
    .p_callback          = gpt_timer2_callback,
...
const timer_cfg_t g_timer8_cfg =
{
    ...
    .channel             = 8,
    .p_callback          = gpt_timer8_callback,
    /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
{
    .mode                = TIMER_MODE_PERIODIC,
    /* Actual period: 10 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0x3b9aca00, .duty_cycle_counts = 0x1dcd6500, .source_div = (timer_source_div_t)0,
    .channel             = 1,
...
{
    .scan_mask           = ADC_MASK_CHANNEL_4 | ADC_MASK_CHANNEL_5 | ADC_MASK_CHANNEL_10 | ADC_MASK_CHANNEL_12 | ADC_MASK_CHANNEL_13 |  0,
    .scan_mask_group_b   =  0,
